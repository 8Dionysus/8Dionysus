...
- profile-level route-index delegation through `docs/START_HERE.md`
...
- shared portable skills or repository-specific skills owned by siblings
...
| Goal Space/operator projection | `aoa-dashboard` | `README.md` -> `docs/ORGAN_CONTRACT.md` -> `docs/ADMISSION.md` | `aoa-dashboard/scripts/validate_organ_contract.py`, `aoa-dashboard` unit tests, `Agents-of-Abyss/generated/ecosystem_registry.min.json`, and `aoa-sdk` workspace discovery; these prove source/workspace registration, not private access or runtime admission |
| profile-only route or glossary correction | `8Dionysus` | `README.md` -> `docs/START_HERE.md` -> `GLOSSARY.md`, `docs/QUESTBOOK_PROFILE_BOUNDARY.md` | `README.md`, `docs/START_HERE.md`, `docs/QUESTBOOK_PROFILE_BOUNDARY.md`, and link review against linked owner repos |

For one concrete workspace capability-delivery disagreement, use the
repository-local `skills/aoa-workspace-diagnose/SKILL.md`, then return any
repair to the named capability or consumer owner. This is a focused diagnostic
capability, not a fourth public onboarding route.
...
- `8Dionysus` for structural parity of its one admitted repo-local home skill;
  manual trials remain the behavioral authority
