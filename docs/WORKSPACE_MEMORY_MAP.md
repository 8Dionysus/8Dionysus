...
| aoa-agents | `live_check_required` | aoa-agents/memo/candidates/20260526T042756Z.fb667e3c.aoa-agents-localized-the-codex-subagent-projecti.candidate.json | `write_candidate` | run live writeback debt check before closeout |
...
| aoa-agents | local-memory-port-candidate | `full_port` | `full_port` | local_port_route | 5 | 0 | 0 | 0 | `PYTHONPATH="${AOA_ABYSS_STACK_ROOT:-$HOME/src/abyss-stack}/mcp/services/aoa-memo-mcp/src" python -m aoa_memo_mcp.cli validate-port --repo aoa-agents` | ok |
