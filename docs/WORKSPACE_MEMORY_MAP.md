...
| aoa-agents | `live_check_required` | aoa-agents/memo/candidates/20260526T044820Z.560c5ae2.aoa-agents-localized-wave-iii-adoption-and-bound.candidate.json | `write_candidate` | run live writeback debt check before closeout |
...
| aoa-agents | local-memory-port-candidate | `full_port` | `full_port` | local_port_route | 6 | 0 | 0 | 0 | `PYTHONPATH="${AOA_ABYSS_STACK_ROOT:-$HOME/src/abyss-stack}/mcp/services/aoa-memo-mcp/src" python -m aoa_memo_mcp.cli validate-port --repo aoa-agents` | ok |
