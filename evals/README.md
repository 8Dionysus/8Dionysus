...
This skeleton `evals/` port preserves public-entry and workspace-route eval
pressure such as owner-route ambiguity cases, AGENTS-map audit fixtures,
workspace projection checks, public onboarding proof questions, and
Codex-plane access-route review cues.
