...
| P0 | 104 | `aoa-models` | `schemas/AGENTS.md` | `add-local-agents` | schema edits are contract edits |
| P0 | 102 | `Dionysus` | `scripts/AGENTS.md` | `add-local-agents` | scripts can mutate, generate, validate, or route other surfaces |
| P0 | 102 | `aoa-dashboard` | `scripts/AGENTS.md` | `add-local-agents` | scripts can mutate, generate, validate, or route other surfaces |
| P0 | 102 | `aoa-models` | `scripts/AGENTS.md` | `add-local-agents` | scripts can mutate, generate, validate, or route other surfaces |
| P0 | 94 | `Dionysus` | `.github/AGENTS.md` | `add-local-agents` | platform automation and workflow metadata are public contracts |
| P0 | 94 | `aoa-models` | `.github/AGENTS.md` | `add-local-agents` | platform automation and workflow metadata are public contracts |
| P0 | 94 | `aoa-session-memory` | `.github/AGENTS.md` | `add-local-agents` | platform automation and workflow metadata are public contracts |
| P0 | 90 | `aoa-models` | `generated/AGENTS.md` | `add-local-agents` | generated outputs should remain evidence, not authority |
| P0 | 90 | `aoa-session-memory` | `generated/AGENTS.md` | `add-local-agents` | generated outputs should remain evidence, not authority |
| P1 | 88 | `aoa-dashboard` | `config/AGENTS.md` | `inspect-then-add` | configuration can shift policy and generation behavior |
| P1 | 84 | `abyss-machine` | `src/AGENTS.md` | `inspect-then-add` | source modules often encode executable or importable behavior |
| P1 | 84 | `aoa-dashboard` | `src/AGENTS.md` | `inspect-then-add` | source modules often encode executable or importable behavior |
...
| P1 | 80 | `aoa-dashboard` | `tests/AGENTS.md` | `inspect-then-add` | tests define what drift is caught |
| P1 | 80 | `aoa-models` | `tests/AGENTS.md` | `inspect-then-add` | tests define what drift is caught |
...
| P2 | 68 | `aoa-dashboard` | `docs/AGENTS.md` | `inspect-first` | docs may carry doctrine, but many docs do not need local law |
| P2 | 68 | `aoa-models` | `docs/AGENTS.md` | `inspect-first` | docs may carry doctrine, but many docs do not need local law |
| P2 | 68 | `aoa-session-memory` | `docs/AGENTS.md` | `inspect-first` | docs may carry doctrine, but many docs do not need local law |
...
| P2 | 64 | `aoa-session-memory` | `examples/AGENTS.md` | `inspect-first` | examples need public-safety and source-sync boundaries |
