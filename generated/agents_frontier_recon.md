...
| P0 | 104 | `Agents-of-Abyss` | `.agents/AGENTS.md` | `add-local-agents` | agent-facing projection surfaces can silently steer tools |
...
| P0 | 92 | `Agents-of-Abyss` | `.github/AGENTS.md` | `add-local-agents` | platform automation and workflow metadata are public contracts |
...
| P1 | 86 | `Agents-of-Abyss` | `config/AGENTS.md` | `inspect-then-add` | configuration can shift policy and generation behavior |
...
| P1 | 84 | `Agents-of-Abyss` | `manifests/AGENTS.md` | `inspect-then-add` | manifests can become hidden coordination contracts |
