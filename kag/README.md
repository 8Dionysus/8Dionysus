...
| source route | `README.md`, `skills/README.md`, `skills/port.manifest.json`, canonical `SKILL.md`, capability and projection decisions, and workspace memory-map sources |
