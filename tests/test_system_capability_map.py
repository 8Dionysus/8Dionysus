...
class SystemCapabilityMapTests(unittest.TestCase):
    def test_capability_map_stays_discoverable_and_owner_bounded(self) -> None:
        ...
        self.assertIn("aoa skills inspect", capability_map)
        self.assertIn("aoa skills capability", capability_map)
        self.assertIn("manual trials", capability_map)
        self.assertNotIn("aoa skills enter", capability_map)
        self.assertNotIn("aoa skills guard", capability_map)
